...
object Producer {
  def main(args: Array[String]): Unit = {
    ...
    Using.Manager { use =>
      val producer = use(new KafkaProducer[String, GenericRecord](props))
      ...
      val paymentSchema2 =
        "{\"type\":\"record\", \"name\":\"Payment\", \"fields\":[{\"name\": \"id\", \"type\": \"string\"}, {\"name\": \"amount\", \"type\": \"double\"}, {\"name\": \"region\", \"type\": \"string\", \"default\": \"\"}]}"
  ...
  def send10(producer: KafkaProducer[String, GenericRecord], topic: String, avroRecord: GenericRecord): Unit = {
